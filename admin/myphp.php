...
echo $query="UPDATE `items` SET `category`='$ucategory',`Title`='$utitle',`item_rating`='$urating',
`image`='$name',`discription`='$udiscription',`price`='$uprice' WHERE itemid='$uid'";
	...
	{
		echo"<script>alert('Item is not Update ');
		 window.location='view_item_list.php';
		 </script>";
	}
}
