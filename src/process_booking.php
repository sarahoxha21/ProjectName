...
?>
<link rel="stylesheet" href="css/validation/css/bootstrapValidator.css"/>
    
<script type="text/javascript" src="css/validation/css/js/bootstrapValidator.js"></script>
  <!-- =============================================== -->
  <?php
    include('form.php');
    $frm=new formBuilder;      
...
<script>
        $(document).ready(function() {
            ...
            verbose: false,
                validators: {notEmpty: {
                        message: 'The V is required and can\'t be empty'
                    },stringLength: {
                    min: 3,
                    max: 3,
