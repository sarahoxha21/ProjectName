...
<option value="FoodgrainsoilMasala">Grains & Oil</option>
<option value="BakerycakesDairy">Bakery & Dairy</option>
<option value="SnacksBrandedFoods">Snacks </option>
<option value="Beverage">Beverages</option>
<option value="Cleaninghousehold">Cleaning Products</option>
</select>
            ...
            <div class="row">
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Project is made by GroAppCreators</a>
